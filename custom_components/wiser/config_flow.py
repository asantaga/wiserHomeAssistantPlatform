...
class WiserFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_zeroconf(self, discovery_info):
        ...
        if not discovery_info.get("name") or not discovery_info["name"].startswith("WiserHeat"):
    ...
    async def async_step_import(self, import_data):
        ...
        try:
            user_input={
                            ...
                            CONF_BOOST_TEMP_TIME: import_data[0][CONF_BOOST_TEMP_TIME] or DEFAULT_BOOST_TEMP_TIME
                        }
