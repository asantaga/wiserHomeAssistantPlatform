...
async def async_register_websockets(hass, data):
    ...
    async_register_command(websocket_get_hubs)
    async_register_command(websocket_get_suntimes)
    async_register_command(websocket_get_schedules)
    async_register_command(websocket_get_schedule_types)
    async_register_command(websocket_get_schedule_by_id)
    async_register_command(websocket_get_rooms)
    async_register_command(websocket_get_devices)
    async_register_command(websocket_assign_schedule)
    async_register_command(websocket_create_schedule)
    async_register_command(websocket_rename_schedule)
    async_register_command(websocket_delete_schedule)
    async_register_command(websocket_save_schedule)
    async_register_command(websocket_copy_schedule)
    async_register_command(websocket_get_zigbee_data)
