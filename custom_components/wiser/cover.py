...
#           is_tilt_supported is a flag provided by the push button to signal that it has the capability
#                to manage manage tilt
#           tilt_enabled is a flag that signal that the device manage the tilt feature
