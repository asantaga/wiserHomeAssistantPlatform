# Wiser Home Assistant Platform (v2.2alpha2)
...
if you want bleeding edge then checkout the `DEV`  branch, however you will need to use the **Manual Code Installation** (described below)
