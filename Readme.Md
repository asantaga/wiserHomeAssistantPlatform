# Drayton Wiser Home Assistant Integration v3.0.21
...
# Change log
- 3.0.22
    * Bump api to 0.0.22 to fix ruamel.yaml install errors on some HA linux platforms
    ...
    * Added LTS sensor for Roomstat humidity
- 3.0.21
    * Bump api to 0.0.20
